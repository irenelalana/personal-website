...
export default function TournamentRulesPage() {
  // 1. Estado para el idioma (predeterminado: Inglés)
    ...
    en: {
      ...
      sections: {
        ...
        gameplay: {
          ...
          throw: "Throw-ins: Taken with hands.",
    ...
    es: {
      ...
      sections: {
        ...
        gameplay: {
          ...
          throw: "Saques de banda: Se realizan con las manos.",
  ...
  // Alias para acortar el acceso al idioma actual
    ...
    <main className="landing-page">
      ...
      <div style={{ 
        ...
        <button 
          ...
          style={{ 
            border: 'none', 
            background: lang === 'en' ? '#02678F' : 'transparent',
            color: lang === 'en' ? '#fff' : '#02678F',
            padding: '5px 12px',
            borderRadius: '20px',
            cursor: 'pointer',
            fontWeight: 'bold'
        ...
        <button 
          ...
          style={{ 
            border: 'none', 
            background: lang === 'es' ? '#02678F' : 'transparent',
            color: lang === 'es' ? '#fff' : '#02678F',
            padding: '5px 12px',
            borderRadius: '20px',
            cursor: 'pointer',
            fontWeight: 'bold'
      ...
      <section className="content-section alt-bg">
        ...
        <div className="card_single">
          <ul className="rules-list">
            ...
            <li><strong>{t.sections.gameplay.throw}</strong></li>
