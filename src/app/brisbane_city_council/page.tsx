        ...
        <div className={styles.cardTop}>
          ...
          <div>
            ...
            <div className={styles.serviceBlock}>
              ...
              <div className={styles.stepBlock}>
                <p><span className={styles.stepTitle}>Step 2:</span> To join any of these sessions, please make sure to <strong>book your spot in advance through the calendar below</strong>, as spaces are limited. You will see a "Booking Confirmed" notification on the site when done.</p>
            ...
            <div className={styles.serviceBlockHoliday}>
              ...
              <p><em>Please note: After filling out the form, you will receive an email confirmation as spots are limited.</em></p>
