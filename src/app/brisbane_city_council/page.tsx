      ...
      <div className="card_single">
        <div className="card-top">
          ...
          <div>
            ...
            <p><strong>Step 2</strong>. To join any of these sessions, please make sure to <strong>book your spot in advance through the calendar below,</strong> as spaces are limited. You will see a "Booking Confirmed" notification on the site when done</p>
            <p>If you are unable to attend, please <strong>cancel your booking as early as possible, via confirmation email</strong> (contact me button is not valid to cancel), so someone else can take your spot as they are limited and usually quite popular.</p>
            <p>If the session is fully booked, please check back closer to the start time, as <strong>spots may open up if participants cancel.</strong></p>
            <BookingCalendar />
            ...
            <p>Sessions were run at Musgrave Park Pool, in West End, Brisbane. Next dates at 11.00am: 9 Apr, 16 Apr 2026.</p>
            ...
            <p>Sessions are run at Musgrave Park Pool, in West End, Brisbane. Next dates 10.00 to 11.00am: 7 Apr, 14 Apr 2026. Thursdays 9 Apr, 16 Apr 2026</p>
            <p>Please, note that after filling the form out with preferences, you will be confirmed by email as spots are limited.</p>
            <form action="https://forms.gle/xWXUSxYNzE5X7D6GA" target="_blank" rel="noreferrer">
              <button className="form-button">Preactivity form</button>
            </form>
