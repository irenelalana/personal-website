      ...
      <div className="card_single">
        <div className="card-top">
          ...
          <div>
            ...
            <p>If you are unable to attend, please cancel your booking as early as possible, via confirmation email, so someone else can take your spot as they are limited and usually quite popular.</p>
            ...
            <p>Sessions were run at Musgrave Park Pool, in West End, Brisbane. Next dates at 11.00am: Thursdays 25 Sep, 2 Oct, 15 Jan, 22 Jan, 9 Apr, 16 Apr 2026.</p>
            ...
            <p>Sessions are run at Musgrave Park Pool, in West End, Brisbane. Next dates 10.00 to 11.00am: Tuesdays 23 Sep, 30 Sep, 13 Jan, 20 Jan, 7 Apr, 14 Apr 2026. Thursdays 25 Sep, 2 Oct, 18 Dec 2025, 15 Jan, 22 Jan, 9 Apr, 16 Apr 2026</p>
            <p>Please, note that after filling the form out with preferences, you will be confirmed by email as spots are limited.</p>
            <form action="https://forms.gle/xWXUSxYNzE5X7D6GA" target="_blank" rel="noreferrer">
              <button className="form-button">Preactivity form</button>
            </form>
