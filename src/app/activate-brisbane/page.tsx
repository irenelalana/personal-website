    ...
    <div className="landing-page" onMouseEnter={() => setIsPaused(true)} onMouseLeave={() => setIsPaused(false)}>
      ...
      <section id="registration-form" className="form-section">
        <div className="card" style={{ maxWidth: '800px', margin: '0 auto' }}>
            ...
            <h2 style={{color: '#d97803', fontSize: '1.2rem', border: '2px solid #d97803', padding: '10px', borderRadius: '5px'}}>Falto yo, contad conmigo!! Until July 5th (Adults $39, Soccer Team $325)</h2>
